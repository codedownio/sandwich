module.exports = {
  docs: [
    ...
    { label: "Formatters", type: "category", items: ["formatters/tui", "formatters/print", "formatters/failure_report", "formatters/log_saver", "formatters/silent", "formatters/slack"] },
