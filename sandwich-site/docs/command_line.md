...
```haskell title="https://github.com/codedownio/sandwich/blob/master/sandwich-demos/demos/command-line-args/Main.hs"
...
stack run command-line-args -- --print --foo asdf --bar 42
```
